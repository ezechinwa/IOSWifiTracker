...
class MapViewController: UIViewController,CLLocationManagerDelegate , GMSMapViewDelegate , GMUClusterManagerDelegate ,UISearchBarDelegate ,GMSAutocompleteViewControllerDelegate  {
